...
export const useBuild = ({
  ...
  const lastBuildOnBranchIsNewer =
    gitInfo?.committedAt && lastBuildOnBranch?.committedAt > gitInfo?.committedAt;
  ...
  return {
    ...
    hasSelectedBuild:
      selectedBuild?.branch === gitInfo?.branch || global.CONFIG_TYPE !== "DEVELOPMENT",
    lastBuildOnBranch,
