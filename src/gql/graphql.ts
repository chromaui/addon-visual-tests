...
export type AddonVisualTestsBuildQuery = {
  __typename?: 'Query', project?: {
    __typename?: 'Project', name: string, lastBuildOnBranch?: (
      { __typename?: 'AnnouncedBuild' }
      ...
      ) | null, lastBuild?: { __typename?: 'AnnouncedBuild', id: string, slug?: string | null } | { __typename?: 'CompletedBuild', id: string, slug?: string | null } | { __typename?: 'PreparedBuild', id: string, slug?: string | null } | { __typename?: 'PublishedBuild', id: string, slug?: string | null } | { __typename?: 'StartedBuild', id: string, slug?: string | null } | null
  } | null, selectedBuild?: (
    { __typename?: 'AnnouncedBuild' }
...
type LastBuildOnBranchBuildFields_CompletedBuild_Fragment = {
  __typename: 'CompletedBuild', result: BuildResult, id: string, status: BuildStatus, committedAt: any, testsForStatus?: {
...
type LastBuildOnBranchBuildFields_StartedBuild_Fragment = {
  __typename: 'StartedBuild', id: string, status: BuildStatus, committedAt: any, testsForStatus?: {
...
type SelectedBuildFields_CompletedBuild_Fragment = {
  __typename: 'CompletedBuild', startedAt: any, id: string, number: number, branch: string, commit: string, committedAt: any, uncommittedHash?: string | null, status: BuildStatus, testsForStory?: {
    __typename?: 'CompletedBuildTestConnection', nodes: Array<(
      { __typename?: 'Test' }
...
type SelectedBuildFields_StartedBuild_Fragment = {
  __typename: 'StartedBuild', startedAt: any, id: string, number: number, branch: string, commit: string, committedAt: any, uncommittedHash?: string | null, status: BuildStatus, testsForStory?: {
    __typename?: 'StartedBuildTestConnection', nodes: Array<(
      { __typename?: 'Test' }
      & { ' $fragmentRefs'?: { 'StoryTestFieldsFragment': StoryTestFieldsFragment } }
    )>
