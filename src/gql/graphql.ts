...
export type AddonVisualTestsBuildQuery = { __typename?: 'Query', project?: { __typename?: 'Project', name: string, nextBuild?: (
      { __typename?: 'AnnouncedBuild' }
  ...
  ) | null, viewer?: { __typename?: 'User', projectMembership?: { __typename?: 'ProjectMembership', canReview: boolean } | null } | null };

type NextBuildFields_AnnouncedBuild_Fragment = { __typename: 'AnnouncedBuild', id: string, committedAt: any } & { ' $fragmentName'?: 'NextBuildFields_AnnouncedBuild_Fragment' };

type NextBuildFields_CompletedBuild_Fragment = { __typename: 'CompletedBuild', result: BuildResult, id: string, committedAt: any, testsForStatus?: { __typename?: 'CompletedBuildTestConnection', nodes: Array<(
      { __typename?: 'Test' }
      ...
      { __typename?: 'Test' }
      & { ' $fragmentRefs'?: { 'NextStoryTestFieldsFragment': NextStoryTestFieldsFragment } }
    )> } | null } & { ' $fragmentName'?: 'NextBuildFields_CompletedBuild_Fragment' };

type NextBuildFields_PreparedBuild_Fragment = { __typename: 'PreparedBuild', id: string, committedAt: any } & { ' $fragmentName'?: 'NextBuildFields_PreparedBuild_Fragment' };

type NextBuildFields_PublishedBuild_Fragment = { __typename: 'PublishedBuild', id: string, committedAt: any } & { ' $fragmentName'?: 'NextBuildFields_PublishedBuild_Fragment' };

type NextBuildFields_StartedBuild_Fragment = { __typename: 'StartedBuild', id: string, committedAt: any, testsForStatus?: { __typename?: 'StartedBuildTestConnection', nodes: Array<(
      { __typename?: 'Test' }
      & { ' $fragmentRefs'?: { 'StatusTestFieldsFragment': StatusTestFieldsFragment } }
    )> } | null, testsForStory?: { __typename?: 'StartedBuildTestConnection', nodes: Array<(
      { __typename?: 'Test' }
      & { ' $fragmentRefs'?: { 'NextStoryTestFieldsFragment': NextStoryTestFieldsFragment } }
    )> } | null } & { ' $fragmentName'?: 'NextBuildFields_StartedBuild_Fragment' };
...
type StoryBuildFields_AnnouncedBuild_Fragment = { __typename: 'AnnouncedBuild', id: string, number: number, branch: string, committedAt: any, uncommittedHash?: string | null, status: BuildStatus } & { ' $fragmentName'?: 'StoryBuildFields_AnnouncedBuild_Fragment' };

type StoryBuildFields_CompletedBuild_Fragment = { __typename: 'CompletedBuild', startedAt: any, id: string, number: number, branch: string, committedAt: any, uncommittedHash?: string | null, status: BuildStatus, testsForStory?: { __typename?: 'CompletedBuildTestConnection', nodes: Array<(
      { __typename?: 'Test' }
      & { ' $fragmentRefs'?: { 'StoryTestFieldsFragment': StoryTestFieldsFragment } }
    )> } | null } & { ' $fragmentName'?: 'StoryBuildFields_CompletedBuild_Fragment' };

type StoryBuildFields_PreparedBuild_Fragment = { __typename: 'PreparedBuild', id: string, number: number, branch: string, committedAt: any, uncommittedHash?: string | null, status: BuildStatus } & { ' $fragmentName'?: 'StoryBuildFields_PreparedBuild_Fragment' };

type StoryBuildFields_PublishedBuild_Fragment = { __typename: 'PublishedBuild', id: string, number: number, branch: string, committedAt: any, uncommittedHash?: string | null, status: BuildStatus } & { ' $fragmentName'?: 'StoryBuildFields_PublishedBuild_Fragment' };

type StoryBuildFields_StartedBuild_Fragment = { __typename: 'StartedBuild', startedAt: any, id: string, number: number, branch: string, committedAt: any, uncommittedHash?: string | null, status: BuildStatus, testsForStory?: { __typename?: 'StartedBuildTestConnection', nodes: Array<(
      { __typename?: 'Test' }
      & { ' $fragmentRefs'?: { 'StoryTestFieldsFragment': StoryTestFieldsFragment } }
...
export type NextStoryTestFieldsFragment = { __typename?: 'Test', status: TestStatus } & { ' $fragmentName'?: 'NextStoryTestFieldsFragment' };
