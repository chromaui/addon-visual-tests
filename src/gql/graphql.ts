...
type NextBuildFields_AnnouncedBuild_Fragment = { __typename: 'AnnouncedBuild', id: string, commit: string, browsers: Array<{ __typename?: 'BrowserInfo', id: string, key: Browser, name: string }> } & { ' $fragmentName'?: 'NextBuildFields_AnnouncedBuild_Fragment' };

type NextBuildFields_CompletedBuild_Fragment = { __typename: 'CompletedBuild', result: BuildResult, id: string, commit: string, changeCount: number, brokenCount: number, testsForStatus?: { __typename?: 'CompletedBuildTestConnection', nodes: Array<(
      { __typename?: 'Test' }
...
type NextBuildFields_PreparedBuild_Fragment = { __typename: 'PreparedBuild', id: string, commit: string, browsers: Array<{ __typename?: 'BrowserInfo', id: string, key: Browser, name: string }> } & { ' $fragmentName'?: 'NextBuildFields_PreparedBuild_Fragment' };

type NextBuildFields_PublishedBuild_Fragment = { __typename: 'PublishedBuild', id: string, commit: string, browsers: Array<{ __typename?: 'BrowserInfo', id: string, key: Browser, name: string }> } & { ' $fragmentName'?: 'NextBuildFields_PublishedBuild_Fragment' };

type NextBuildFields_StartedBuild_Fragment = { __typename: 'StartedBuild', id: string, commit: string, changeCount: number, brokenCount: number, testsForStatus?: { __typename?: 'StartedBuildTestConnection', nodes: Array<(
      { __typename?: 'Test' }
      & { ' $fragmentRefs'?: { 'StatusTestFieldsFragment': StatusTestFieldsFragment } }
