...
export type AddonVisualTestsBuildQueryVariables = Exact<{
  ...
  storyBuildId: Scalars['ID']['input'];
  hasStoryBuildId: Scalars['Boolean']['input'];
}>;


export type AddonVisualTestsBuildQuery = { __typename?: 'Query', project?: { __typename?: 'Project', name: string, lastBuild?: (
      { __typename?: 'AnnouncedBuild' }
      & { ' $fragmentRefs'?: { 'NextBuildFields_AnnouncedBuild_Fragment': NextBuildFields_AnnouncedBuild_Fragment;'StoryBuildFields_AnnouncedBuild_Fragment': StoryBuildFields_AnnouncedBuild_Fragment } }
    ) | (
      { __typename?: 'CompletedBuild' }
      & { ' $fragmentRefs'?: { 'NextBuildFields_CompletedBuild_Fragment': NextBuildFields_CompletedBuild_Fragment;'StoryBuildFields_CompletedBuild_Fragment': StoryBuildFields_CompletedBuild_Fragment } }
    ) | (
      { __typename?: 'PreparedBuild' }
      & { ' $fragmentRefs'?: { 'NextBuildFields_PreparedBuild_Fragment': NextBuildFields_PreparedBuild_Fragment;'StoryBuildFields_PreparedBuild_Fragment': StoryBuildFields_PreparedBuild_Fragment } }
    ) | (
      { __typename?: 'PublishedBuild' }
      & { ' $fragmentRefs'?: { 'NextBuildFields_PublishedBuild_Fragment': NextBuildFields_PublishedBuild_Fragment;'StoryBuildFields_PublishedBuild_Fragment': StoryBuildFields_PublishedBuild_Fragment } }
    ) | (
      { __typename?: 'StartedBuild' }
      & { ' $fragmentRefs'?: { 'NextBuildFields_StartedBuild_Fragment': NextBuildFields_StartedBuild_Fragment;'StoryBuildFields_StartedBuild_Fragment': StoryBuildFields_StartedBuild_Fragment } }
    ) | null } | null, storyBuild?: (
    { __typename?: 'AnnouncedBuild' }
    & { ' $fragmentRefs'?: { 'StoryBuildFields_AnnouncedBuild_Fragment': StoryBuildFields_AnnouncedBuild_Fragment } }
  ) | (
    { __typename?: 'CompletedBuild' }
    & { ' $fragmentRefs'?: { 'StoryBuildFields_CompletedBuild_Fragment': StoryBuildFields_CompletedBuild_Fragment } }
  ) | (
    { __typename?: 'PreparedBuild' }
    & { ' $fragmentRefs'?: { 'StoryBuildFields_PreparedBuild_Fragment': StoryBuildFields_PreparedBuild_Fragment } }
  ) | (
    { __typename?: 'PublishedBuild' }
    & { ' $fragmentRefs'?: { 'StoryBuildFields_PublishedBuild_Fragment': StoryBuildFields_PublishedBuild_Fragment } }
  ) | (
    { __typename?: 'StartedBuild' }
    & { ' $fragmentRefs'?: { 'StoryBuildFields_StartedBuild_Fragment': StoryBuildFields_StartedBuild_Fragment } }
  ) | null };

type NextBuildFields_AnnouncedBuild_Fragment = { __typename: 'AnnouncedBuild', id: string, commit: string, committedAt: any, browsers: Array<{ __typename?: 'BrowserInfo', id: string, key: Browser, name: string }> } & { ' $fragmentName'?: 'NextBuildFields_AnnouncedBuild_Fragment' };

type NextBuildFields_CompletedBuild_Fragment = { __typename: 'CompletedBuild', result: BuildResult, id: string, commit: string, committedAt: any, changeCount: number, brokenCount: number, testsForStatus?: { __typename?: 'CompletedBuildTestConnection', nodes: Array<(
      { __typename?: 'Test' }
      & { ' $fragmentRefs'?: { 'StatusTestFieldsFragment': StatusTestFieldsFragment } }
    )> } | null, browsers: Array<{ __typename?: 'BrowserInfo', id: string, key: Browser, name: string }> } & { ' $fragmentName'?: 'NextBuildFields_CompletedBuild_Fragment' };

type NextBuildFields_PreparedBuild_Fragment = { __typename: 'PreparedBuild', id: string, commit: string, committedAt: any, browsers: Array<{ __typename?: 'BrowserInfo', id: string, key: Browser, name: string }> } & { ' $fragmentName'?: 'NextBuildFields_PreparedBuild_Fragment' };

type NextBuildFields_PublishedBuild_Fragment = { __typename: 'PublishedBuild', id: string, commit: string, committedAt: any, browsers: Array<{ __typename?: 'BrowserInfo', id: string, key: Browser, name: string }> } & { ' $fragmentName'?: 'NextBuildFields_PublishedBuild_Fragment' };

type NextBuildFields_StartedBuild_Fragment = { __typename: 'StartedBuild', id: string, commit: string, committedAt: any, changeCount: number, brokenCount: number, testsForStatus?: { __typename?: 'StartedBuildTestConnection', nodes: Array<(
      { __typename?: 'Test' }
      & { ' $fragmentRefs'?: { 'StatusTestFieldsFragment': StatusTestFieldsFragment } }
    )> } | null, browsers: Array<{ __typename?: 'BrowserInfo', id: string, key: Browser, name: string }> } & { ' $fragmentName'?: 'NextBuildFields_StartedBuild_Fragment' };

export type NextBuildFieldsFragment = NextBuildFields_AnnouncedBuild_Fragment | NextBuildFields_CompletedBuild_Fragment | NextBuildFields_PreparedBuild_Fragment | NextBuildFields_PublishedBuild_Fragment | NextBuildFields_StartedBuild_Fragment;

type StoryBuildFields_AnnouncedBuild_Fragment = { __typename: 'AnnouncedBuild', id: string, number: number, branch: string, uncommittedHash?: string | null, status: BuildStatus } & { ' $fragmentName'?: 'StoryBuildFields_AnnouncedBuild_Fragment' };

type StoryBuildFields_CompletedBuild_Fragment = { __typename: 'CompletedBuild', startedAt: any, id: string, number: number, branch: string, uncommittedHash?: string | null, status: BuildStatus, testsForStory?: { __typename?: 'CompletedBuildTestConnection', nodes: Array<(
      { __typename?: 'Test' }
      & { ' $fragmentRefs'?: { 'StoryTestFieldsFragment': StoryTestFieldsFragment } }
    )> } | null } & { ' $fragmentName'?: 'StoryBuildFields_CompletedBuild_Fragment' };

type StoryBuildFields_PreparedBuild_Fragment = { __typename: 'PreparedBuild', id: string, number: number, branch: string, uncommittedHash?: string | null, status: BuildStatus } & { ' $fragmentName'?: 'StoryBuildFields_PreparedBuild_Fragment' };

type StoryBuildFields_PublishedBuild_Fragment = { __typename: 'PublishedBuild', id: string, number: number, branch: string, uncommittedHash?: string | null, status: BuildStatus } & { ' $fragmentName'?: 'StoryBuildFields_PublishedBuild_Fragment' };

type StoryBuildFields_StartedBuild_Fragment = { __typename: 'StartedBuild', startedAt: any, id: string, number: number, branch: string, uncommittedHash?: string | null, status: BuildStatus, testsForStory?: { __typename?: 'StartedBuildTestConnection', nodes: Array<(
      { __typename?: 'Test' }
      & { ' $fragmentRefs'?: { 'StoryTestFieldsFragment': StoryTestFieldsFragment } }
    )> } | null } & { ' $fragmentName'?: 'StoryBuildFields_StartedBuild_Fragment' };

export type StoryBuildFieldsFragment = StoryBuildFields_AnnouncedBuild_Fragment | StoryBuildFields_CompletedBuild_Fragment | StoryBuildFields_PreparedBuild_Fragment | StoryBuildFields_PublishedBuild_Fragment | StoryBuildFields_StartedBuild_Fragment;
