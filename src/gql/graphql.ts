...
export type AddonVisualTestsBuildQuery = {
  __typename?: 'Query', build?: (
    ...
    & { ' $fragmentRefs'?: { 'BuildFields_AnnouncedBuild_Fragment': BuildFields_AnnouncedBuild_Fragment } }
      ...
      __typename?: 'Project', name: string, lastBuild?: (
        { __typename?: 'AnnouncedBuild' }
        & { ' $fragmentRefs'?: { 'BuildFields_AnnouncedBuild_Fragment': BuildFields_AnnouncedBuild_Fragment } }
      ) | (
          { __typename?: 'CompletedBuild' }
...
type BuildFields_CompletedBuild_Fragment = {
  __typename: 'CompletedBuild', result: BuildResult, startedAt: any, id: string, number: number, branch: string, commit: string, uncommittedHash?: string | null, status: BuildStatus, changeCount: number, brokenCount: number, testsForStatus?: {
    __typename?: 'CompletedBuildTestConnection', nodes: Array<(
      { __typename?: 'Test' }
  ...
  } | null, browsers: Array<{ __typename?: 'BrowserInfo', id: string, key: Browser, name: string }>
} & { ' $fragmentName'?: 'BuildFields_CompletedBuild_Fragment' };
...
type BuildFields_StartedBuild_Fragment = {
  __typename: 'StartedBuild', startedAt: any, id: string, number: number, branch: string, commit: string, uncommittedHash?: string | null, status: BuildStatus, changeCount: number, brokenCount: number, testsForStatus?: {
    __typename?: 'StartedBuildTestConnection', nodes: Array<(
      { __typename?: 'Test' }
      & { ' $fragmentRefs'?: { 'StatusTestFieldsFragment': StatusTestFieldsFragment } }
    )>
  } | null, testsForStory?: {
...
} & { ' $fragmentName'?: 'BuildFields_StartedBuild_Fragment' };
