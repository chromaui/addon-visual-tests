...
export type SelectProjectsQueryQuery = { __typename?: 'Query', accounts?: Array<{ __typename?: 'Account', id: string, name: string, avatarUrl?: string | null, projects?: Array<{ __typename?: 'Project', id: string, name: string, webUrl: any, code: string, lastBuild?: { __typename?: 'TestedBuild', branch: string, number: number } | null } | null> | null } | null> | null };
